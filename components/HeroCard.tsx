...
const HeroCard = () => {
  return (
    <div className="relative z-30 w-full bg-primarybg font-manrope ">
      <div className="max-w-7xl mx-auto px-4 -translate-y-16">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">

          <div className="bg-blue-950 rounded-lg flex flex-col items-center p-2">
            <div className="text-2xl bg-primaryYellow text-center text-black font-bold rounded-md p-2">
          ...
          <div className="bg-blue-950 rounded-lg flex flex-col items-center p-2">
            <div className="text-2xl bg-primaryYellow text-center text-black font-bold p-6 rounded-md">
